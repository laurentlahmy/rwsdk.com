		...
		<div>
			...
			<div className="relative min-h-[70vh] sm:min-h-screen w-full mb-10 sm:mb-20 top-[-60px]">
              ...
              This could be the start of something small
						...
						{/* <h3 className="text-[18px] sm:text-[24px] md:text-[32px]  font-mil text-center leading-[0.9] text-orange-light max-w-[1060px] mx-auto  tracking-[-0.03em] font-thin">
							RedwoodSDK is a React framework for building server-side web apps
							on Cloudflare
						</h3> */}
			...
			<section className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-10 items-center justify-center py-8 sm:py-8 md:py-16 px-3 sm:px-4 md:px-8 max-w-[1300px] mx-auto">
				<div className="flex flex-col gap-3 sm:gap-4 max-w-[743px] text-center lg:text-left">
					<h2 className="text-[36px] sm:text-[48px] md:text-[58px] lg:text-[65px] font-apple  tracking-[-0.03em] leading-[81%] mb-3 grid-bg py-4 px-2">
					...
					>
						Start the beginner course, its 40 minutes long and its free!
					</a>
				</div>
			</section>
			...
			<section className="max-w-[1300px] mx-auto">
				<h3 className="text-[26px] sm:text-[48px] md:text-[58px] lg:text-[65px] font-light font-apple  tracking-[-0.03em] leading-[81%] mb-3 grid-bg py-4 px-2  max-w-[1400px] mx-auto">
					One Response to build them all
				</h3>
				{featureBlocks.map((block, idx) => (
					<div key={block.title}>
						<div
							className={`flex flex-col md:flex-row gap-6 sm:gap-8 lg:gap-16 items-center justify-center py-6 sm:py-8 md:py-16 px-3 sm:px-4 md:px-8 max-w-[1400px] mx-auto ${idx % 2 === 1 ? "md:flex-row-reverse" : ""}`}
						>
			...
			<section className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-16 items-center justify-center py-8 sm:py-8 md:py-16 px-3 sm:px-4 md:px-8 max-w-[1300px] mx-auto">
				...
				<div className="col-span-1 lg:col-span-2">
					<div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
						<h3 className="text-[36px] sm:text-[48px] md:text-[58px] lg:text-[65px] font-light font-apple  tracking-[-0.03em] leading-[81%] mb-3 grid-bg py-4 px-2  max-w-[1400px] mx-auto">
			...
			<section className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-16 items-center py-8 sm:py-8 md:py-16 px-3 sm:px-4 md:px-8 max-w-[1300px] mx-auto">
				<div className="col-span-1 lg:col-span-2">
					<div className="flex flex-col gap-4 sm:gap-6 md:gap-8 text-left">
						<h3 className="text-[36px] sm:text-[48px] md:text-[58px] lg:text-[65px] font-light font-apple  tracking-[-0.03em] leading-[81%] mb-3 grid-bg">
			...
			<section className="py-8 sm:py-8 md:py-16 px-3 sm:px-4 md:px-8 max-w-[1300px] mx-auto">
				<div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
					<h3 className="text-[36px] sm:text-[48px] md:text-[58px] lg:text-[65px] font-light font-apple  tracking-[-0.03em] leading-[81%] mb-3 grid-bg py-4 px-2 mx-auto">
