...
const cspDirectives = {
	...
	"style-src":
		"'self' 'unsafe-inline' https://fonts.googleapis.com https://fonts.cdnfonts.com",
	...
	return (
		<html lang="en">
			<head>
				...
				<title>RedwoodSDK Blog | The React framework for Cloudflare</title>{" "}
				...
				<meta
					name="description"
					content="RedwoodSDK is the JavaScript SDK for Cloudflare Workers. It provides a complete set of composable tools to handle the request/response lifecycle of webapps."
				/>
				<meta
					name="keywords"
					content="RedwoodSDK, RedwoodJS, React, TypeScript, Prisma, TailwindCSS, RedwoodJS SDK, Cloudflare Development Platform, response lifecycle, webapps"
				/>
